              ...
              children: [
                ...
                Center(
                  child: CircleAvatar(
                    ...
                    //Text
                    child: Icon(
                      Icons.person, size: 50, color: AppColors.accentColorPink,
                    ),
                  ),
                ),
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Full Name', style: kLoginPageTextFieldHintTextStyle.copyWith(color: AppColors.accentColorDarkPink)),
                    CustomTextFieldLogin(textController: textControllerName,hintText: 'yourname',)
                  ],
                ),
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Location', style: kLoginPageTextFieldHintTextStyle.copyWith(color: AppColors.accentColorDarkPink)),
                    CustomTextFieldLogin(textController: textControllerPassword,hintText: 'yourpassword',)
                  ],
                ),
